...
class ArgeoProfile extends StatefulWidget {
  @override
  _ArgeoProfileState createState() => _ArgeoProfileState();
}

class _ArgeoProfileState extends State<ArgeoProfile> {
  ...
  _launchFbURL() async {
    const url = 'https://www.facebook.com/argeo.thelian';
  ...
  _launchTwitterURL() async {
    const url = 'https://twitter.com/Argeo_Thelian/';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  _launchInstaURL() async {
    const url = 'https://www.instagram.com/argeothelian/';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage("assets/images/argeo.png"),
                          fit: BoxFit.cover)),
                ),
              ),
              Padding(
                          ...
                          onPressed: () async {
                            if (_registerFormKey.currentState.validate()) {
                              email = Email(
                                ...
                                recipients: ['argeo.thelian@gmail.com'],
